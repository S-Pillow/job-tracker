...
export function StepItem({ step, isCurrent, isLocked = false }: Props) {
  ...
  const isDisabled = isPending || isNA || isLocked;
  ...
  return (
    <div className="group">
      {/* STOP warning banner above step row */}
      {step.isStopWarning && (
      ...
      <div
        className={[
          ...
          isCurrent && !isComplete && !step.isGate && !step.isStopWarning && !isLocked
          ...
          <div className="flex items-start gap-2 flex-wrap">
            <span
              className={[
                ...
                isCurrent && !isComplete && !isLocked ? 'text-zinc-900 font-medium' : '',
